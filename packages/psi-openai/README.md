...
// sig=ed25519:...; verify=https://ai-governance-standard.com/verify/psi_...
```
...
See [the spec](https://ai-governance-standard.com/standard) and
[the live inspector](https://ai-governance-standard.com/header).
