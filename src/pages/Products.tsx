        ...
        <section className="px-4 pb-8" id="catalogue">
          <div className="container mx-auto max-w-7xl">
            ...
            <p className="text-xs text-muted-foreground text-center mt-8 max-w-3xl mx-auto">
              Prices in USD. Checkout is handled by Stripe. Sealing and public verification remain free
              and unmetered — paying only ever adds the institutional countersignature, anchoring,
              persistence and support around a proof you can already generate yourself.
            </p>
          </div>
        </section>
