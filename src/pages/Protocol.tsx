...
const Protocol = () => {
  return (
    <>
      <Helmet>
        <title>PSI Protocol — Proof of Stateful Integrity — Apex PSI — Universal Verification Protocol</title>
        ...
        <meta property="og:url" content="https://ai-governance-standard.com/protocol" />
              ...
              {[
                {
                  ...
                  items: [
                    ...
                    "Tamper-evident: metadata cannot be removed without breaking the signature",
