...
import { WM_METHOD } from "@/lib/psi-watermark";
...
const VERIFY_STEPS = [
  ...
  "For rasters, recover the RGB-LSB watermark by majority vote and compare it against the declared digest.",
];
...
{MANIFEST_EXAMPLE}
        ...
        <Section title="Cryptographic stack">
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              ...
              { n: "Watermark", s: WM_METHOD, d: "16-byte sync header + 32-byte digest, repeated across RGB LSBs, majority-vote recovery." },
            ].map((c) => (
        ...
        <Section title="Scope and limits">
          <ul className="space-y-2 text-xs text-foreground/75">
            ...
            <li>• The invisible watermark survives lossless handling (PNG, copy, container remux). Heavy lossy re-encoding, rescaling or cropping below one payload period will degrade or destroy it; in-band metadata then remains the primary marker.</li>
