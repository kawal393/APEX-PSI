...
const ScoreCard = () => {
  ...
  const pageUrl = `https://ai-governance-standard.com/score/${shareId}`;
  ...
  return (
    <>
      <Helmet>
        <title>{data.company_name} — {score}% AI Compliance Score — Apex PSI — Universal Verification Protocol</title>
