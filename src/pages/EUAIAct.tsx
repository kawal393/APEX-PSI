...
export default function EUAIAct() {
  ...
  return (
    <>
      <Helmet>
        <title>EU AI Act Code of Practice — Section 1 Compliance — Apex PSI — Universal Verification Protocol</title>
        <meta name="description" content="APEX PSI technical documentation for Section 1 of the EU Code of Practice on Transparency of AI-Generated Content: in-band signed tamper-evident metadata, C2PA Content Credentials, Ed25519 + ML-DSA-65." />
